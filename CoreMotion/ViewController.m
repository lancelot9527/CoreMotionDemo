...
- (UISwitch *)controlSwitch{
    ...
    if (!_controlSwitch) {
        ...
        _controlSwitch = [[UISwitch alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-24.5, 50, 70, 40)];
        [_controlSwitch addTarget:self action:@selector(pullOrPush) forControlEvents:UIControlEventValueChanged];
        
        
        UILabel *pullLabl = [[UILabel alloc]initWithFrame:CGRectMake(50, 50, 50, 40)];
        pullLabl.textColor = [UIColor whiteColor];
        pullLabl.text = @"Pull";
        pullLabl.textAlignment = NSTextAlignmentCenter;
        [self.view addSubview:pullLabl];
        
        UILabel *pushLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-100, 50, 50, 40)];
...
- (UILabel *)gyroTitleLabel{
    ...
    if (!_gyroTitleLabel) {
        ...
        _gyroTitleLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-75, 200, 150, 30)];
...
- (UILabel *)gyroXLabel{
    ...
    if (!_gyroXLabel) {
        ...
        _gyroXLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 250, 100, 30)];
...
- (UILabel *)gyroYLabel{
    ...
    if (!_gyroYLabel) {
        ...
        _gyroYLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-50, 250, 100, 30)];
...
- (UILabel *)gyroZLabel{
    ...
    if (!_gyroZLabel) {
        ...
        _gyroZLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-110, 250, 100, 30)];
...
- (UILabel *)accelerometerTitleLabel{
    ...
    if (!_accelerometerTitleLabel) {
        ...
        _accelerometerTitleLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-75, 300, 150, 30)];
...
- (UILabel *)accelerometerXLabel{
    ...
    if (!_accelerometerXLabel) {
        ...
        _accelerometerXLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 350, 100, 30)];
...
- (UILabel *)accelerometerYLabel{
    ...
    if (!_accelerometerYLabel) {
        ...
        _accelerometerYLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-50, 350, 100, 30)];
...
- (UILabel *)accelerometerZLabel{
    ...
    if (!_accelerometerZLabel) {
        ...
        _accelerometerZLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-110, 350, 100, 30)];
